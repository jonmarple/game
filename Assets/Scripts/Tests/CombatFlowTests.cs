    ...
    public void TestFlow()
    {
        CombatFlow.Initialize(
            new CharacterGroup(new List<Character>(new Character[] { new Character("a1", null, null, new StatBlock(10, 10, 2, 5, 2, new Spread(5, 2)), new Equipment(new Armor("", new Spread(2, 1), new Spread(2, 1)), new Weapon("", new Spread(4, 1), new Spread(0, 0), new Attack("att1", 1, 1), new Attack("att2", 2, 2))), new CharacterAI()),
                                                                     ...
                                                                     new Character("a3", null, null, new StatBlock(10, 10, 2, 5, 2, new Spread(5, 2)), new Equipment(new Armor("", new Spread(2, 1), new Spread(2, 1)), new Weapon("", new Spread(0, 0), new Spread(3, 1), new Attack("att1", 1, 1), new Regen("reg1", 2, 1, RegenType.HP))), new CharacterAI()),
                                                                     new Character("a4", null, null, new StatBlock(10, 10, 2, 5, 2, new Spread(5, 2)), new Equipment(new Armor("", new Spread(2, 1), new Spread(2, 1)), new Weapon("", new Spread(0, 0), new Spread(3, 1), new Attack("att1", 1, 1), new Regen("reg1", 2, 1, RegenType.HP))), new CharacterAI()) })),
